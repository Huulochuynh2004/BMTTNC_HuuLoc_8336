...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(170, 110, 401, 71))
        ...
        self.txt_key.setGeometry(QtCore.QRect(170, 210, 401, 20))
        self.txt_key.setObjectName("txt_key")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(50, 270, 71, 16))
        self.label_4.setObjectName("label_4")
        self.txt_cipher_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(170, 270, 401, 71))
        self.txt_cipher_text.setObjectName("txt_cipher_text")
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(230, 390, 75, 23))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(460, 390, 75, 23))
